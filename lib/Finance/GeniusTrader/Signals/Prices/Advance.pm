package Finance::GeniusTrader::Signals::Prices::Advance;
...
Finance::GeniusTrader::Signals::Advance

=head1 DESCRIPTION

The Advance Signal will be able to tell you if a security is advancing more than x % or not from the previous period.
